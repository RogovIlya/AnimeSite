...
(function ($) {
	$.rating = function (e, o) {
		...
		if (this.val > this.options.stars)
			this.val = this.options.stars;
		if (this.val < 0)
			this.val = 0;
		this.old = this.val;
	...
	$r.fn.extend({
		...
		declOfNum : function (number) {
			...
			cases = [2, 0, 1, 1, 1, 2];
			return "<b>Рейтинг:</b>&nbsp;"+this.old+"/"+this.options.stars + "<br>" + this.options.titles[(number % 100 > 4 && number % 100 < 20) ? 2 : cases[(number % 10 < 5) ? number % 10 : 5]]+": "+number;
		}
	});
